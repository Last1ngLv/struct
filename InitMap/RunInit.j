library RunInit initializer Init requires SelectionSystem, TerrainReplaceConfi
    ...
    // Compatibilidad con trigger clásico, pero sin gg_trg_gg.
...
// powershell -NoProfile -ExecutionPolicy Bypass -File "build/build-jass.ps1"
